  ...
  <div class="body">
    <div class="box-top">
      <van-nav-bar title="课程详情" left-arrow @click-left="onLeft">
        ...
        <template #right>
          <van-icon name="other-pay" size="18" />
        </template>
      </van-nav-bar>
    </div>

    <van-tabs v-model="active" scrollspy sticky line-height="0px" title-active-color="red">
      <div class="top">
      ...
      <div style="width:7.5rem;height:3rem;margin-top:0.3rem;background: white;">
        <p>教学团队</p>
        <div style="margin-left:0.5rem;">
          <br />
        ...
        <div class="box2">
          ...
          <div style="margin-left:0.5rem">
            <div v-for="i in 5" :key="i">
              ...
              <van-button type="primary" color="orange" size="mini">回放</van-button>
              <span>第一讲第一课时</span>
      ...
      <van-tab title="课程评价">
        <div class="box3">
          <p>课程评价</p>
          <div>
            <div style="margin-left:0.3rem;height:1rem;display: flex;" v-for="i in 9" :key="i">
              <!-- <div> -->
                <img class="im2" src="/favicon.ico" alt />
                <div><span>159456613</span>
                <br>
                <span>哇擦</span>
                </div>
