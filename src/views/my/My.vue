...
<van-overlay :show="show" @click="show = false">
    ...
    <div class="add">
      ...
      <div class="box_bottom">
          ...
          <div class="login">
            <img src="https://msmk2019.oss-cn-shanghai.aliyuncs.com/uploads/avatar.jpg" class="im" alt="">
            <div class="login_right">
              <div><span @click="add('/about')">登录</span>/<span>注册</span></div>
              <span class="xx">🏒</span>
      ...
      <div class="jxsfq">
        ...
        <ul>
          ...
          <li>
           ...
           <div class="item_box">
                <div v-for="(item,index) in list.li2" :key="index"  @click="add(item.path)"  class="item_box_lia">
                  <img :src="item.im" alt="">
                  <p>{{item.title}}</p>
                </div>
            </div>
          ...
          <li>
            ...
            <div class="item_box">
                <div v-for="(item,index) in list.li4" :key="index"  class="item_box_lia">
                  <img :src="item.im" alt="">
                  <p>{{item.title}}</p>
                </div>
            </div>
