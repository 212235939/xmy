...
<van-overlay :show="show" @click="show = false">
    ...
    <div class="add">
      ...
      <div class="box_bottom">
          ...
          <div class="login">
            <img src="https://msmk2019.oss-cn-shanghai.aliyuncs.com/uploads/avatar.jpg" class="im" alt="" @click="add('/pim')">
            <div class="login_right">
              <div v-if="user==undefined"><span @click="add('/about')">登录</span>/<span @click="add('/Register')">注册</span></div>
              <span v-else>{{user}}</span>
              <span class="xx"></span>
              <span class="toa" @click="add('/onetutoring')">去约课</span>
            </div>
          </div>
          ...
          <div class="add_bot">
            <div class="bot_sew">
              <p style="font-size:0.5rem;color:rgb(235, 97, 0);">0</p>
              <p style="font-size:0.25rem">我的特色课</p>
              <p style="font-size:0.2rem;color:#ccc;">已购特色课程的学习</p>
            </div>
            <div class="bot_sew" @click="add('/Lesson')">
              <p style="font-size:0.5rem;color:rgb(235, 97, 0);">0</p>
              <p style="font-size:0.25rem">一对一辅导</p>
              <p style="font-size:0.2rem;color:#ccc;">我的一对一老师辅导</p>
            </div>
            <div class="bot_sew" @click="add('/sum')">
              <p style="font-size:0.5rem;color:rgb(235, 97, 0);">0</p>
              <p style="font-size:0.25rem">剩余学习币</p>
              <p style="font-size:0.2rem;color:#ccc;">查看剩余学习币</p>
            </div>
      ...
      <div class="jxsfq">
        ...
        <ul>
          <li>
            ...
            <div class="item_box">
                <div v-for="(item,index) in list.li1" :key="index"  class="item_box_lia" @click="add(item.path)">
                  <img :src="item.im" alt="">
                  <p>{{item.title}}</p>
                </div>
          ...
          <li>
           ...
           <div class="item_box">
                <div v-for="(item,index) in list.li2" :key="index"  @click="add(item.path,item.val)"  class="item_box_lia">
                  <img :src="item.im" alt="">
                  <p>{{item.title}}</p>
                </div>
            </div>
          ...
          <li>
            ...
            <div class="item_box">
                <div v-for="(item,index) in list.li3" :key="index"  @click="add(item.path)"  class="item_box_lia">
                  <img :src="item.im" alt="">
                  <p>{{item.title}}</p>
                </div>
            </div>
          ...
          <li>
            ...
            <div class="item_box">
                <div v-for="(item,index) in list.li4" :key="index"  @click="add(item.path)"  class="item_box_lia">
                  <img :src="item.im" alt="">
                  <p>{{item.title}}</p>
                </div>
            </div>
...
.xx{
  margin-left: 0.15rem;
    background: url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADwAAAA+CAYAAAB3NHh5AAAPbElEQ…F/F/SLvQQuqPLV303AqB9CPWQBL7OFGOnhz19sSoOvfr7+Pzk1XP97Kb4pAAAAAElFTkSuQmCC) 50% no-repeat;
